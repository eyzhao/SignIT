...
#include "stanExports_signit_model_infer_populations.h"

RCPP_MODULE(stan_fit4signit_model_infer_populations_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_signit_model_infer_populations")
