...
#include "stanExports_signature_model.h"

RCPP_MODULE(stan_fit4signature_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_signature_model")
