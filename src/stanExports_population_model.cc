...
#include "stanExports_population_model.h"

RCPP_MODULE(stan_fit4population_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_population_model")
